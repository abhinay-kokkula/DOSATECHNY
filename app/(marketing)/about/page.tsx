...
const timeline = [
  ...
  { year: "2024", event: "DOSATECHNY founded as a focused studio for search-first product engineering." },
  { year: "2026", event: "Expanded into global delivery with cloud-native architecture and API platform practice." },
];

const team = [
  { name: "Abhinay kokkula", role: "Founder & Developer" },
];
      ...
      <section className="section-spacing">
        <div className="container-shell">
          <Reveal>
            ...
            <h1 className="mt-4 max-w-4xl font-display text-4xl md:text-6xl">People will think its a food item But  </h1>
            <p className="mt-6 max-w-3xl text-lg text-brand-muted">
              We started DOSATECHNY to build websites that helps you to visible your online presence anywhere in the online.
            </p>
          </Reveal>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              {team.map((member) => (
                <article key={member.name} className="group rounded-2xl border border-white/10 bg-brand-surface/65 p-5 transition-colors hover:border-brand-primary/35">
                  <div className="mb-4 h-28 rounded-xl bg-gradient-to-br from-brand-primary/15 via-transparent to-brand-secondary/20" />
